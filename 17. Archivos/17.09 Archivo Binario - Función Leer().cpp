...
void leer(){
    ...
    archivoB.open("Prueba.dat",ios::in | ios::binary); // Abrimos el archivo en modo lectura y binario
    ...
    archivoB.read((char *)&persona,sizeof(Registro)); // Leemos la estructura completa dentro del archivo binario

    cout<<"\n\nMostrando los datos leídos"<<endl;
    cout<<"Nombre: "<<persona.nombre<<endl; // Mostramos en pantalla el nombre almacenado en la estructura
    cout<<"Apellido: "<<persona.apellido<<endl; // Mostramos en pantalla el apellido almacenado en la estructura
