...
void menu(){
    ...
    do{
        ...
        switch(opcion){
            case 1: cout<<"Digite un número entero: "; // Solicitamos un dato al usuario para insertarlo en la lista
                    cin>>dato;
    ...
    }while(opcion != 3); // Repetimos el proceso hasta que el usuario elija la opción 'Salir'
}
